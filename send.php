...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $mail->Username = 'kreativekuantum@gmail.com';  // Your Gmail address (use your own Gmail account for sending)
        $mail->Password = 'vtdccqfzskelpgdp';  // Your Gmail App Password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;  // Enable TLS encryption
        $mail->Port = 587;  // TCP port to connect to

        // Recipients
        $mail->setFrom('kreativekuantum@gmail.com', 'Mailer');  // Your Gmail address for sending
        $mail->addAddress('kreativekuantum@gmail.com', 'Krupakar Reddy');  // Add recipient
